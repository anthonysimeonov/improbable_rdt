...
from rrp_robot.collision.conet_model.conet_coll_checker_full import LocalPoolPointnet, LocalDecoder, ConvolutionalOccupancyNetwork
...
models_dir = osp.join(path_util.get_rrp_src(), 'collision/gripper_models')
...
class PointCollision():
    def __init__(self, model, robotiq=False):
        ...
        weights_folder = osp.join(path_util.get_rrp_model_weights(), 'conet_weights')
