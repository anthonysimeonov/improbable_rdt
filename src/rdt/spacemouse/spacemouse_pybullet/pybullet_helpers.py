"""From: https://github.com/caelan/pybullet-planning/blob/master/pybullet_tools/utils.py"""
...
def get_joint_states(body, joints):
    return tuple(get_joint_state(body, joint) for joint in joints)
